        ...
        <div class="bg-brand-dark1/60 backdrop-blur-md border border-brand-dark4/40 rounded-2xl p-8 shadow-[0_10px_30px_rgba(0,0,0,0.3)] relative overflow-hidden">
            ...
            <div class="flex items-center gap-4 mb-8 border-b border-brand-dark4/40 pb-6">
                ...
                <div>
                    ...
                    <h1 class="text-xl font-bold text-white mt-0.5">Cadastro de Calendário</h1>
                    <p class="text-sm text-brand-dark5 mt-1">Preencha os dados abaixo para registrar um novo horário no sistema.</p>
                </div>
            </div>

            <form method="POST" action="api/cadastros/cadastrar_calendario_alunos.php" class="space-y-6">
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="data" class="block text-xs font-semibold text-brand-dark5 uppercase tracking-wider mb-2">Data</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="time" class="block text-xs font-semibold text-brand-dark5 uppercase tracking-wider mb-2">Hora</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <div class="pt-4 mt-6 border-t border-brand-dark4/40 space-y-4">
                    ...
                    <div class="text-center text-sm pt-2">
                        <a href="index.php?page=calendario_aluno.php" class="font-medium text-brand-dark5 hover:text-white transition-colors flex items-center justify-center gap-1 group">
