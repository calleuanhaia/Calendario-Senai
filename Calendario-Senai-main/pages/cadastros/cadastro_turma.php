    ...
    <main class="relative z-10 w-full max-w-md my-auto py-8">
        ...
        <div class="bg-brand-dark1/90 backdrop-blur-2xl border border-brand-dark4/50 rounded-3xl p-6 sm:p-8 shadow-[0_25px_60px_rgba(0,0,0,0.6)] relative overflow-hidden">
            ...
            <div class="flex flex-col items-center justify-center mb-6">
                ...
                <h1 class="text-xl font-bold text-white mb-1">Cadastro de Turma</h1>
                <p class="text-xs text-brand-dark5 font-light text-center">Preencha os dados abaixo para criar e associar uma nova turma.</p>
            </div>

            <form method="POST" action="api/cadastros/cadastrar_turmas.php" class="space-y-4">
                ...
                <div>
                    <label for="aluno" class="block text-sm font-semibold text-gray-300 mb-1.5 ml-1">Aluno</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <div>
                    <label for="periodo" class="block text-sm font-semibold text-gray-300 mb-1.5 ml-1">Período</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i data-lucide="clock" class="w-5 h-5 text-brand-dark5"></i>
                        </div>
                        <select id="periodo" name="periodo" required
                            class="w-full pl-11 pr-12 py-3 bg-brand-dark2 border border-brand-dark4/60 rounded-xl text-white focus:outline-none focus:border-brand-accent focus:ring-1 focus:ring-brand-accent transition-all duration-300 appearance-none cursor-pointer">
